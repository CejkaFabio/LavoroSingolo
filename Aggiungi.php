...
<body>
    ...
    <br>
        <form method="post" action="">
            ...
            <center><h2>ADD THE CONTROLS</h2></center>
            ...
            <div class="container col-xs-4" align="center">
            <div class="form-group">
                <a href="http://localhost/SQLBartoliniCejka-master/index.php?"><input type="indietro" class="btn btn-primary btn-block" name='Indietro' value="Indietro" id="insert"></a>
            </div>
            </div>
        </form>
        </div>
